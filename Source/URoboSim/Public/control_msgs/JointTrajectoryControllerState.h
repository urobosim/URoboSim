...
{
	class JointTrajectoryControllerState : public FROSBridgeMsg
	{
	...
	public:
		...
		{
			MsgType = "control_msgs/JointTrajectoryControllerState";
		}
		...
		~JointTrajectoryControllerState() override {}
		...
		static JointTrajectoryControllerState GetFromJson(TSharedPtr<FJsonObject> JsonObject)
		{
			JointTrajectoryControllerState Result;
