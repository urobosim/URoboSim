...
{
	class GripperCommandFeedback : public FROSBridgeMsg
	{
		double Position;
		double Effort;
		bool Stalled;
	...
	public:
		...
		{
			MsgType = "control_msgs/GripperCommandFeedback";
		}
		...
		~GripperCommandFeedback() override {}
		...
		static GripperCommandFeedback GetFromJson(TSharedPtr<FJsonObject> JsonObject)
		{
			GripperCommandFeedback Result;
