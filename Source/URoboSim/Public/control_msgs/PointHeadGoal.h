...
{
	class PointHeadGoal : public FROSBridgeMsg
	{
	...
	public:
		PointHeadGoal()
		{
			MsgType = "control_msgs/PointHeadGoal";
		}
		...
		static PointHeadGoal GetFromJson(TSharedPtr<FJsonObject> JsonObject)
		{
			PointHeadGoal Result;
