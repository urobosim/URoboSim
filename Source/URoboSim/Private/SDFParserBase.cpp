...
USDFDataAsset* FSDFParserBase::ParseToNewDataAsset(UObject* InParent, FName InName, EObjectFlags InFlags)
{
  if (!bSDFLoaded)
    {
      return nullptr;
...
bool FSDFParserBase::IsValidSDF()
{
  if (XmlFile == nullptr)
    {
      return false;
...
// Parse <model> node
void FSDFParserBase::ParseModel(const FXmlNode* InNode)
{
...
//// Parse <link> node
//void FSDFParserBase::ParseLink(const FXmlNode* InNode, USDFModel*& OutModel)
//{
//  // Ptr to the new link
...
void FSDFParserBase::ParseLinkInertial(const FXmlNode* InNode, USDFLink*& OutLink)
{
...
// Parse <geometry> node
void FSDFParserBase::ParseGeometry(const FXmlNode* InNode, USDFGeometry*& OutGeometry, ESDFType Type)
{
...
//void FSDFParserBase::ParseGeometryMesh(const FXmlNode* InNode, USDFGeometry*& OutGeometry, ESDFType Type)
//{
//  // Set geometry type
...
void FSDFParserBase::ParseGeometryBox(const FXmlNode* InNode, USDFGeometry*& OutGeometry)
{
  // Set geometry type
...
void FSDFParserBase::ParseGeometryCylinder(const FXmlNode* InNode, USDFGeometry*& OutGeometry)
{
  // Set geometry type
...
void FSDFParserBase::ParseGeometrySphere(const FXmlNode* InNode, USDFGeometry*& OutGeometry)
{
  // Set geometry type
...
// Parse <joint> node
void FSDFParserBase::ParseJoint(const FXmlNode* InNode, USDFModel*& OutModel)
{
...
void FSDFParserBase::ParseJointAxis(const FXmlNode* InNode, USDFJoint*& OutJoint)
{
...
void FSDFParserBase::ParseJointAxisLimit(const FXmlNode* InNode, USDFJoint*& OutJoint)
{
...
FTransform FSDFParserBase::PoseContentToFTransform(const FString& InPoseData)
{
...
FVector FSDFParserBase::XyzToFVector(const FString& InXyzData)
{
...
FVector FSDFParserBase::SizeToFVector(const FString& InSizeData)
{
  // <size>x=[0] y=[1] z=[2]</size>
  TArray<FString> DataArray;
